  ...
  return (
    <div
      ...
      className={`relative bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-[1.02] hover:shadow-lg flex flex-col h-full
        ...
        ${isSelected && isSelectionMode ? 'ring-2 ring-blue-500 border-blue-500' : 'border border-transparent'}`}
    >
      {!isSelectionMode ? (
...
const CardContent = ({ property, isWishlisted, isWishlistButtonDisabled, toggleWishlist, isSelectionMode, isSelected, canOnlyRemove }: CardContentProps) => ( // <--- DESTRUCTURED HERE
  <>

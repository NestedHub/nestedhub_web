...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!authLoading) { // Ensure auth state has been determined
    ...
    <AdminSidebar>
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-md text-gray-600">Welcome back, <span className="font-semibold">{user?.name || 'Admin'}</span>!</p>
        </div>
